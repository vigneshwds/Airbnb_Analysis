...
if user=='Home':
    ...
    st.markdown("**:blue[Technologies Used :] Pandas, Seaborn, Python Scripting, MongoDB, Streamlit and Plotly**")
    st.write('')
    ...
    tab1, tab2, tab3, tab4 = st.tabs(['**Price Analysis**', '**Room Type Analysis**', '**Review Analysis**', '**Room Availabilities**'])
