...
def price_analysis(df):
  ...
  st.markdown("**:red[Interpretation :] The bar and donut charts help to understand how price listings vary from Room types**")  
...
if user=='Home':
    ...
    tab1, tab2, tab3, tab4 = st.tabs(['**Price Analysis**', '**Room Type Analysis**', '**Review Analysis**', '**Top Neighborhood**'])
